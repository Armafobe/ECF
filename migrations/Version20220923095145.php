 ...
 */
final class Version20220923095145 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_permissions (user_id INT NOT NULL, permissions_id INT NOT NULL, INDEX IDX_84F605FA9C3E4F87 (permissions_id), INDEX IDX_84F605FAA76ED395 (user_id), PRIMARY KEY(user_id, permissions_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
