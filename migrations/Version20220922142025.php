 ...
 */
final class Version20220922142025 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP perms');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD perms LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\'');
    }
}
